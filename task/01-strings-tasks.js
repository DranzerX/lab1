...
function encodeToRot13(str) {
    ...
    for (var i = 0; i < str.length; i++) {
        var n = first.search('[' + str.charAt(i) + ']');
        if (n == -1)
            out += str.charAt(i);
        else
            out += second.charAt(n);
...
function getCardId(value) {
    ...
    var cards = "A♣2♣3♣4♣5♣6♣7♣8♣9♣0♣J♣Q♣K♣A♦2♦3♦4♦5♦6♦7♦8♦9♦0♦J♦Q♦K♦A♥2♥3♥4♥5♥6♥7♥8♥9♥0♥J♥Q♥K♥A♠2♠3♠4♠5♠6♠7♠8♠9♠0♠J♠Q♠K♠";
    var pos = cards.search('('+value+')');
    return (pos - pos % 2) / 2;
    //throw new Error('Not implemented');
}
