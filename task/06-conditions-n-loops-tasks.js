...
function doRectanglesOverlap(rect1, rect2) {
    return (rect2.left >= rect1.left &&
        ...
        rect2.top >= rect1.top &&
        rect2.top <= rect1.top + rect1.height) || (rect2.left + rect2.width >= rect1.left &&
        rect2.left + rect2.width <= rect1.left + rect1.width &&
        rect2.top >= rect1.top &&
        rect2.top <= rect1.top + rect1.height) || (rect2.left >= rect1.left &&
        rect2.left <= rect1.left + rect1.width &&
        rect2.top + rect2.height >= rect1.top &&
        rect2.top + rect2.height <= rect1.top + rect1.height) || (rect2.left + rect2.width >= rect1.left &&
        rect2.left + rect2.width <= rect1.left + rect1.width &&
        rect2.top + rect2.height >= rect1.top &&
        ...
        rect1.top >= rect2.top &&
        rect1.top <= rect2.top + rect2.height) || (rect1.left + rect1.width >= rect2.left &&
        rect1.left + rect1.width <= rect2.left + rect2.width &&
        rect1.top >= rect2.top &&
        rect1.top <= rect2.top + rect2.height) || (rect1.left >= rect2.left &&
        rect1.left <= rect2.left + rect2.width &&
        rect1.top + rect1.height >= rect2.top &&
        rect1.top + rect1.height <= rect2.top + rect2.height) || (rect1.left + rect1.width >= rect2.left &&
        rect1.left + rect1.width <= rect2.left + rect2.width &&
        rect1.top + rect1.height >= rect2.top &&
...
function isInsideCircle(circle, point) {
    var d = Math.sqrt((circle.center.x - point.x) * (circle.center.x - point.x) + (circle.center.y - point.y) * (circle.center.y - point.y));
